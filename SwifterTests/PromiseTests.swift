...
class PromiseTests: XCTestCase {
    ...
    func testStateFold() -> () {
        ...
        let promise1 = Promise<Int>()
        promise1.stateFold({ _ in onFulfilled = true }, { _ in onPending = true })
    ...
    func testAwait() -> () {
        ...
        promise1.await()
        XCTAssertTrue(finishedExecuting)
        XCTAssertEqual(promise2.value!.toOption()!, Int.max/10)
